...
const METRICS_FR: TickerMetric[] = [
  ...
  { tag: "MATÉRIEL", label: "Mini PC Référence", value: "Dell Wyse 5070 / HP 705 (~40-70 €)" },
  ...
  { tag: "MOTEUR", label: "Lecteur vidéo", value: "MPV + VA-API (Intel & AMD matériel)" },
...
const METRICS_EN: TickerMetric[] = [
  ...
  { tag: "HARDWARE", label: "Reference mini PC", value: "Dell Wyse 5070 / HP 705 (~$40-70)" },
  ...
  { tag: "ENGINE", label: "Playout core", value: "MPV + VA-API (Intel & AMD hardware)" },
