...
export default function DocsMobileNav({ locale, items }: DocsMobileNavProps) {
  ...
  const currentIndex = items.findIndex(([sub]) => {
  ...
  // Fermer le menu lors d'un changement de route (pattern React recommandé)
  ...
  return (
    <>
      <div className="docs-mobile-nav-wrapper">
        ...
        {isOpen && (
          <>
            <div className="docs-mobile-nav-backdrop" onClick={() => setIsOpen(false)} />
