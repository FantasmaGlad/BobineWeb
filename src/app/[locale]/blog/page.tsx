...
export default async function BlogIndexPage({
  ...
  return (
    <div className="container" style={{ paddingBlock: "clamp(1rem, 2.5vh, 2.5rem)", maxWidth: "60rem" }}>
      ...
      <section className="blog-hero-viewport">
        <div>
          <div
            style={{
              display: "flex",
        ...
        <div className="page-hero__scroll">
          <span>{locale === "en" ? "Scroll down to see all releases" : "Défiler pour voir toutes les versions"}</span>
      ...
      {releases.length > 1 && (
        <div style={{ paddingTop: "clamp(2.5rem, 5vh, 4rem)" }}>
